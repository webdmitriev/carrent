<template>
  <div>
    ...
    <div class="carpark preveiwCar">
      ...
      <div class="container">
        <busketPostEn :post="post" :postId="postId" @submit="onSubmitted" />
      </div>
...
import post from "@/components/Parts/PreveiwCarEn.vue";
import busketPostEn from "@/components/Parts/busketPostEn";
